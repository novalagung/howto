...
const config = {
  ...
  projectName: 'howto', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      metadata: [
        {
          name: 'keywords', content: 'tutorial, it tutorial, tech, it blog, how to, novalagung, noval agung',
        },
        {
          name: 'author', content: 'Noval Agung Prayogo',
        },
        {
          property: 'og:image', content: 'https://howto.novalagung.com/img/cover_media_share.png?v=1',
        },
        {
          property: 'og:type', content: 'article',
        }
      ],
      image: 'https://howto.novalagung.com/img/cover_media_share.png?v=1',
      navbar: {
        title: 'How To',
        logo: {
          alt: 'How To - A bunch of tech tutorials',
      ...
      prism: {
        ...
        additionalLanguages: ['bash', 'log', 'toml'],
      },
      // algolia: {
      //   appId: '65RXJ98QVA',
      //   apiKey: 'be8c782c081c9e5a001dbbaa6ffdd859',
      //   indexName: 'howto-novalagung',
